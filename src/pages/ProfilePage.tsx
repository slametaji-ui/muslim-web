...
const ProfilePage: React.FC = () => {
    ...
    const handleShare = async () => {
        const shareData = {
            ...
            text: `Kenalin nih Qolbi, "Pendamping Muslim Modern" pilihan saya. 🌙✨ Desainnya premium banget, fiturnya lengkap dari jadwal sholat sampai pelacak amalan harian dan tentunya Bebas Iklan. Yuk, istiqomah bareng pakai Qolbi! Cek di sini ya:`,
        ...
        if (navigator.share) {
            ...
            try {
                ...
                showToast('Link aplikasi & pesan ajakan berhasil disalin!', 'success');
            } catch (err) {
